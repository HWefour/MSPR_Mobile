...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  // Nouvelle fonction pour effectuer l'appel à l'API
          ...
          children: <Widget>[
                    ...
                    child: Padding(
                      ...
                      child: isChecked
                          ? Icon(
                              ...
                              size: 16.0,
                              color: Color(
                                  0xFF1B5E20), // Couleur de la coche verte
                            )
                          : Container(
                              width: 16.0,
                              height: 16.0,
            ...
            ElevatedButtonWidget(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  // Gérer la soumission du formulaire ici
                  fetchDataFromAPI(); // Appeler l'API lorsque le bouton d'inscription est appuyé
                }
              },
            ),
          ],
