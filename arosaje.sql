...
-- -----------------------------------------------------
-- Table `aorasaje`.`Roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Roles` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Users` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Botaniste`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Botaniste` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Photos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Photos` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Annonces`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Annonces` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Annonces_has_Photos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Annonces_has_Photos` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Commentaires_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Commentaires_users` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Commentaire_photo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Commentaire_photo` (
...
-- -----------------------------------------------------
-- Table `aorasaje`.`Commentaires_users_has_Users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aorasaje`.`Commentaires_users_has_Users` (
